...
I made all devices in workroom [MacGyver SH](https://macgyver.siliconhill.cz/) (I used measuring devices, tools and others). Mr [bkralik](https://github.com/bkralik helped me with the milling work of the box (the part Installation box – type2).
